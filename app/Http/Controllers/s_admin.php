...
class s_admin extends Controller
{
   ...
   public function event_info($id)
    ...
    {
        $event_data=tblevent::join('tblcoordinaters','tblevents.cid','=','tblcoordinaters.cid')->join('tblcategory','tblcategory.category_id','tblcoordinaters.cate_id')
        ->where('tblevents.clgcode',Session::get('aclgcode'))->get();
